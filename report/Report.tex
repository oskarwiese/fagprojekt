...
The illustration \ref{fig:sex_truerecid} does not seem to match with figure \ref{fig:predictedrecidsex} as more female are placed in low risk of recidivism and more males in high risk. Thus, a bias could be present, but the figure \ref{fig:predictedrecidsex} shows no sign of bias.
