...
%\usepackage{program}
%\title{Fairness in Classification - Correction of Racial and Gender Discrimination in the COMPAS Dataset}

\title{Discrimination of Race \& Gender in the COMPAS Dataset}

%\title{Racist and Sexist Classifiers and how to Correct Them}
