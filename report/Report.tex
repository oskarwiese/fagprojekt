...
%TODO: \\ referér til kode og software}
	...
	To obtain a standard deviation of the model accuracy ten different folds of the dataset were constructed. This was done by splitting the data into ten equal sized arrays and combining these into ten different train test splits. Here is an iluustration of a 5-fold split, 
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.4\linewidth]{imgs/kfolds}
		\caption{Illustrates how the data was split into folds. Image found at \href{https://www.researchgate.net/figure/The-technique-of-KFold-cross-validation-illustrated-here-for-the-case-K-4-involves_fig10_278826818}{ResearchGate} \cite{researchgate}. }
		\label{fig:kfolds}
	\end{figure}
