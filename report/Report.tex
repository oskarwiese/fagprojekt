...
%	\textbf{TODO: \\ referér til kode og software \\ brug lang tid på nye %metoder, kort tid på gamle metoder}
	...
	\begin{figure}[H]
		...
		\caption{Visualization of the binary classifier model. The input layer has dimension $ \mathbb R ^8$ and the output layer has dimension $ \mathbb R^1 $. The number of nodes in the hidden layers is a changeable parameter which is found with Bayesian Optimization. }
		\label{fig:ffnn}
	\end{figure}
	...
	\begin{itemize}
		...
		\item Number of units in the fourth hidden layer \(\in [1, 5000]\)
		\item Number of units in the fifth hidden layer \(\in [1, 5000]\)
