...
%	\end{figure}
	...
	It is important for society to gain trust in machine learning models and artificial intelligence. Steps in order to ensure this trust has already been taken. The Ministry of Foreign Affairs of Denmark has with the cooperation of the research enviroment taken steps in order to ensure that any future development and use of AI live up to democratic values and control mechanisms.If there is no trust in the machine learning industry from society there will be no personal data available. Without the availability of personal data that companies, such as google has, no AI models or machine learning models can be developed. And without AI - no personal services will be available. The aim is to make sure consumers and companies who interact with AI services and products developed in Denmark are able to trust, that they live up to the highest ethical standards. \cite{larsk} Professor Lars Kai Hansen, has produced a list of principles, which ensures safe AI. These are the following, 
