...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imgs/predicted_recid_race}
		\caption{}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imgs/true_recid}
		\caption{}
		\label{fig:truerecid}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imgs/predicted_recid_sex}
		\caption{}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imgs/proirs}
		\caption{}
		\label{fig:proirs}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imgs/c_charge_degree}
		\caption{}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imgs/charge_degree_score}
		\caption{}
